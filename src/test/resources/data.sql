...
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'tutkimus', 0);
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'henkilosto', 0);
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'toiminnanohjaus', 0);
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'talous', 1);
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'opetus', 0);
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'history', 0);
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'johto', 0);
INSERT INTO HIERARCHY_PUBLICITY (ID , HIERARCHY, PUBLICITY) values (NODE_SEQ.nextval, 'uusi_henkilosto', 0);

INSERT INTO NODE (ID, NAME, UNIQUE_ID) VALUES ('treeTestRoot', 'TREE TEST ROOT', 'treeTestRoot');
INSERT INTO NODE (ID, NAME, UNIQUE_ID) VALUES ('treeTestRoot1', 'TREE TEST ROOT 1', 'treeTestRoot1');
INSERT INTO NODE (ID, NAME, UNIQUE_ID) VALUES ('treeTestChild1', 'TREE TEST CHILD 1', 'treeTestChild1');
INSERT INTO NODE (ID, NAME, UNIQUE_ID) VALUES ('treeTestChild2', 'TREE TEST CHILD 2', 'treeTestChild2');
INSERT INTO NODE (ID, NAME, UNIQUE_ID) VALUES ('treeTestChild3', 'TREE TEST CHILD 3', 'treeTestChild3');
INSERT INTO NODE (ID, NAME, UNIQUE_ID, START_DATE, END_DATE) VALUES ('treeTestExpiredOne', 'TREE TEST EXPIRED ONE', 'treeTestChild4', DATE'1600-01-01', DATE'1700-01-01');

INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, NULL, 'treeTestRoot', NULL, NULL, 'treeTest');
INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, NULL, 'treeTestRoot1', NULL, NULL, 'treeTest');
INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, NULL, 'treeTestRoot1', NULL, NULL, 'treeTest1');
INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, 'treeTestRoot', 'treeTestChild1', NULL, NULL, 'treeTest');
INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, 'treeTestRoot', 'treeTestChild2', NULL, NULL, 'treeTest');
INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, 'treeTestChild2', 'treeTestChild3', NULL, NULL, 'treeTest');
INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, 'treeTestChild2', 'treeTestExpiredOne', NULL, NULL, 'treeTest');
INSERT INTO EDGE (ID, PARENT_NODE_ID, CHILD_NODE_ID, START_DATE, END_DATE, HIERARCHY) VALUES (NODE_SEQ.NEXTVAL, NULL, 'treeTestChild2', DATE'1600-01-01', DATE'1700-01-01', 'treeTest');

INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('HYYYYY, University of Helsinki (HY)',TIMESTAMP '2000-01-02 00:00:00.000000',TIMESTAMP '2023-07-31 00:00:00.000000','a1','en');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('HEIHEI, University of Helsinki (AAAAA)',TIMESTAMP '2023-08-01 00:00:00.000000',NULL,'a1','en');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('Kuninkaallinen Turun Akatemia',TIMESTAMP '1640-03-25 00:00:00.000000',TIMESTAMP '1827-12-31 00:00:00.000000','a1','fi');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('Keisarillinen Aleksanterin Yliopisto',TIMESTAMP '1828-01-02 00:00:00.000000',TIMESTAMP '1919-02-16 00:00:00.000000','a1','fi');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('Helsingin yliopisto',TIMESTAMP '1919-02-17 00:00:00.000000',TIMESTAMP '1999-12-31 00:00:00.000000','a1','fi');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('HYYYYY, Helsingin yliopisto (HY)',TIMESTAMP '2000-01-02 00:00:00.000000',TIMESTAMP '2023-07-31 00:00:00.000000','a1','fi');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('HEIHEI, Helsingin yliopisto (AAAAA)',TIMESTAMP '2023-08-01 00:00:00.000000',NULL,'a1','fi');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('HYYYYY, Helsingfors universitet (HY)',TIMESTAMP '2000-01-02 00:00:00.000000',TIMESTAMP '2023-07-31 00:00:00.000000','a1','sv');
INSERT INTO FULL_NAME (NAME,START_DATE,END_DATE,NODE_ID,"LANGUAGE") VALUES ('HEIHEI, Helsingfors universitet (AAAAA)',TIMESTAMP '2023-08-01 00:00:00.000000',NULL,'a1','sv');
