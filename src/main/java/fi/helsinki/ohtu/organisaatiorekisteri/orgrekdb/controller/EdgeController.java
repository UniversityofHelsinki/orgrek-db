...
public class EdgeController {
    ...
    public ResponseEntity<Map<String, List<EdgeWrapper>>> updateParents(@RequestBody Map<String, List<EdgeWrapper>> attributesMap) {
        try {
            edgePropertiesService.updateDeleteOrSaveUpperUnit(attributesMap);
