SELECT PN.ID, PN.UNIQUE_ID, PN.START_DATE, PN.END_DATE, P.START_DATE edge_start_date, P.END_DATE edge_end_date, FN.NAME full_name, FN.LANGUAGE FROM PREDECESSOR_RELATION P
