SELECT 
	...
	EDUCATION_QUALIFIER_HIERARCHY_FILTER."VALUE" AS EDUCATION_QUALIFIER,
...
FROM EDGE 
	...
	JOIN HIERARCHY_FILTER TYPE_HIERARCHY_FILTER ON TYPE_HIERARCHY_FILTER.HIERARCHY = EDGE.HIERARCHY 
		AND TYPE_HIERARCHY_FILTER."KEY" = 'type' AND TYPE_HIERARCHY_FILTER."VALUE" NOT IN ('toimintayksikko', 'toimielin', 'osasto')
  ...
  LEFT JOIN NODE_ATTR EDUCATION_QUALIFIER ON EDUCATION_QUALIFIER.NODE_ID = NODE.ID
	...
	LEFT JOIN HIERARCHY_FILTER EDUCATION_QUALIFIER_HIERARCHY_FILTER ON EDUCATION_QUALIFIER_HIERARCHY_FILTER.HIERARCHY = EDGE.HIERARCHY
		AND EDUCATION_QUALIFIER_HIERARCHY_FILTER.KEY='koulutus_tarkenne'
		AND EDUCATION_QUALIFIER_HIERARCHY_FILTER."VALUE" = EDUCATION_QUALIFIER."VALUE"
