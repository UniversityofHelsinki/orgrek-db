...
FROM EDGE E
         JOIN NODE N ON
            E.PARENT_NODE_ID = :nodeId AND E.CHILD_NODE_ID = N.ID AND E.HIERARCHY != 'history'
         ...
         LEFT JOIN FULL_NAME CURR ON FUTURE.NODE_ID IS NULL AND PAST.NODE_ID IS NULL AND E.CHILD_NODE_ID = CURR.NODE_ID AND LANGUAGES.LANGUAGE = CURR.LANGUAGE AND
